...
vec3 wave(vec3 src, vec2 position, float tt, vec3 color, float posFactors[2], float timeFactors[2], int level) {
	float value = 0.0;
	for(int i=0; i<2; i++) {
